...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/lung.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/yolo_0.9/yolov5m6/weights/best.pt', help='model.pt path(s)')
